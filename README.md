...
**FollKernel** 是一只从 **KernelSU** 花园里长出来的魔法管理器 🌱  
她不会偷偷把 Root 权限塞给陌生人，而是把最终决定权郑重地交到你手里。

这里不是冷冰冰的工具箱，而是属于你的**玩机小屋** —— 模块、KPM、主题色、刷写、日志，全部被她整理得井井有条。只要你的设备搭载了 KernelSU / KernelPatch，FollKernel 就会牵着你的手，一起探索 Android 的深层世界 ✨
...
|:------:|---------|----------------|
| 🛡️ | **超级用户授权** — 决定谁可以、谁不可以触碰 Root | Per-app superuser grant/deny with lifetime control |
| 📦 | **模块管理** — 安装 / 启用 / 禁用 / 卸载 ZIP 模块 | Install, enable, disable and uninstall ZIP modules |
| ⚔️ | **KPM 内核补丁** — 加载 `.kpm` 补丁，GKI 模式下也能嵌入 | Load `.kpm` kernel patches, embeddable in GKI mode |
...
[![Download APK](https://img.shields.io/badge/⬇%20下载%20APK-ec407a?style=for-the-badge&logo=android&logoColor=white)](https://github.com/Spring-bulid/FollKernel/releases/latest)
[![Official Docs](https://img.shields.io/badge/📖%20官方文档-7c4dff?style=for-the-badge)](https://spring-bulid.github.io/FollKernel/)
...
> 小提示：Windows 环境下请使用 `gradlew.bat` 喵～
