package com.mikokernel.magica;

import static com.mikokernel.magica.AppZygotePreload.TAG;
...
import com.mikokernel.ui.util.KsuCliKt;
...
public class BootCompletedReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (!Intent.ACTION_LOCKED_BOOT_COMPLETED.equals(action)
                ...
                && !"com.mikokernel.magica.LAUNCH".equals(action)) {
            return;
        }
