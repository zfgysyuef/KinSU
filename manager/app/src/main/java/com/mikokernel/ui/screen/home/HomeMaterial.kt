                ...
                when {
                    state.ksuVersion != null -> {
                        ...
                        Column(Modifier.padding(start = 20.dp)) {
                            ...
                            Text(
                                text = stringResource(R.string.superuser) + ": " + state.superuserCount.toString(),
                                style = MaterialTheme.typography.bodyMedium
                            )
                            Spacer(Modifier.height(2.dp))
                            Text(
                                text = stringResource(R.string.module) + ": " + state.moduleCount.toString(),
                                style = MaterialTheme.typography.bodyMedium
                            )
                        }
                    }
...
private fun previewHomeScreenState(
    ...
    latestVersionInfo = com.mikokernel.ui.util.module.LatestVersionInfo(),
